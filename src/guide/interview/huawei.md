...
从应用角度来说，这个系统就是一个创新，实现了对各类型人员行动规律的分析，~~在具体的实现技术栈或者实现方法上并没有创新点。~~
...
分布式软总线是在`1+8+N`的框架下所提出的，所谓的1+8+N，1指的是手机，8指的是是车机、音箱、耳机、手表/手环、平板、大屏、PC、AR/VR，N指的是其他IOT设备，分布式软总线的提出就是为了解决所有1+8+N设备之间的互联问题。
