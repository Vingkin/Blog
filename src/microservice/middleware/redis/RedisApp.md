...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/1653057872536.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/1653059409865.png)

#### 1.1.3、导入后端项目

在资料中提供了一个项目源码：

![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/1653060237073.png)

#### 1.1.4、导入前端工程

![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/1653060337562.png)

#### 1.1.5 运行前端项目

![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/1653060588190.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/1653067054461.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/1653068196656.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211405378.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211405795.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211405583.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211406471.png)

####  1.9.2、优化方案

既然之前的拦截器无法对不需要拦截的路径生效，那么我们可以添加一个拦截器，在第一个拦截器中拦截所有的路径，把第二个拦截器做的事情放入到第一个拦截器中，同时刷新令牌，因为第一个拦截器有了threadLocal的数据，所以此时第二个拦截器只需要判断拦截器中的user对象是否存在即可，完成整体刷新功能。

![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211406354.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211406038.png)

#### 2.1.2、代码如下

代码思路：如果缓存有，则直接返回，如果缓存不存在，则查询数据库，然后存入redis。

![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211406722.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211406488.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211406065.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211407583.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211407182.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211407363.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211407793.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211407811.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211407143.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211407218.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211407369.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211407709.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211408141.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211408297.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211408242.png)

为了增加ID的安全性，我们可以不直接使用Redis自增的数值，而是拼接一些其它信息：

![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211408246.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211408972.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211408374.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211408083.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211408724.png)

超卖问题是典型的多线程安全问题，针对这一问题的常见解决方案就是加锁：而对于加锁，我们通常有两种解决方案：见下图：

![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211408129.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211408999.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211409045.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211409010.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211409436.png)

2、然后修改nginx的conf目录下的nginx.conf文件，配置反向代理和负载均衡：

![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211409530.png)
...
![](https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309211409093.png)
...
![](https://124.71.187.148/images/redis/1653374296906.png)
...
![](https://124.71.187.148/images/redis/1653381992018.png)
...
* 获取锁：
  ...
  * 非阻塞：尝试一次，成功返回true，失败返回false
    ...
    # 下面方法如果在俩个操作之间服务宕机了，依然会有bug
    SETNX lock thread1
    # 两个操作不具备原子性，这边有可能出bug
    EXPIRE lock 10
    ```
...
flowchart TB
  ...
  do --> e1[释放锁]
  sg1 -- 业务超时或服务器宕机 --> e3[自动释放锁]
  
  style st color: #dfe6e9, fill: #636e72, stroke: #000, stroke-width: 0px
  style e1 color: #dfe6e9, fill: #636e72, stroke: #000, stroke-width: 0px
  style e2 color: #dfe6e9, fill: #636e72, stroke: #000, stroke-width: 0px
  style e3 color: #dfe6e9, fill: #636e72, stroke: #000, stroke-width: 0px
  style cond fill: #ffb500, stroke: #000, stroke-width: 0px
  style sg1 stroke: #636e72, stroke-width: 2px, stroke-dasharray: 5
```

我们利用redis 的setnx 方法，当有多个线程进入时，我们就利用该方法，第一个线程进入时，redis 中就有这个key 了，返回了1，如果结果是1，则表示他抢到了锁，那么他去执行业务，然后再删除锁，退出锁逻辑，没有抢到锁的哥们，等待一定时间后重试即可

![](https://124.71.187.148/images/redis/1653382830810.png)
...
public interface ILock {
     ...
     * 尝试获取锁
     *
     * @param timeoutSec 锁持有的超时事件，过期后自动释放
...
![](https://124.71.187.148/images/redis/1653385920025.png)
...
![](https://124.71.187.148/images/redis/1653387398820.png)
...
public void unlock() {
    ...
    String threadId = ID_PREFIX + Thread.currentThread().getId();
    // 获取缓存的ID
    String cacheId = redisTemplate.opsForValue().get(KEY_PREFIX + name);
    // 如果缓存的ID和当前线程的ID相同，则删除缓存
...
![](https://124.71.187.148/images/redis/1653387764938.png)

### 4.7、Lua脚本解决多条命令原子性问题

Redis提供了Lua脚本功能，在一个脚本中编写多条Redis命令，确保多条命令执行时的原子性。Lua是一种编程语言，它的基本语法大家可以参考网站：https://www.runoob.com/lua/lua-tutorial.html, 这里重点介绍Redis提供的调用函数，我们可以使用lua去操作redis，又能保证他的原子性，这样就可以实现拿锁、比锁、删锁是一个原子性动作了，作为Java程序员这一块并不作一个简单要求，并不需要大家过于精通， 只需要知道他有什么作用即可。
...
![](https://124.71.187.148/images/redis/1653392181413.png)

例如，我们要执行 redis.call('set', 'name', 'jack') 这个脚本，语法如下：

![](https://124.71.187.148/images/redis/1653392218531.png)

如果脚本中的key、value不想写死，可以作为参数传递。key类型参数会放入KEYS数组，其它参数会放入ARGV数组，在脚本中可以从KEYS和ARGV数组获取这些参数：

![](https://124.71.187.148/images/redis/1653392438917.png)
...
![](https://124.71.187.148/images/redis/1653393304844.png)
...
但是目前还剩下一个问题锁不住，什么是锁不住呢，你想一想，如果当过期时间到了之后，我们可以给他续期一下，比如续个 30s，就好像是网吧上网， 网费到了之后，然后说，来，网管，再给我来10块的，是不是后边的问题都不会发生了，那么续期问题怎么解决呢，可以依赖于我们接下来要学习redission啦

**测试逻辑：**

第一个线程进来，得到了锁，手动删除锁，模拟锁超时了，其他线程会执行 lua 来抢锁，当第一天线程利用lua删除锁时，lua能保证他不能删除他的锁，第二个线程删除锁时，利用lua同样可以保证不会删除别人的锁，同时还能保证原子性。

## 5、分布式锁-Redisson

### 5.1、分布式锁-Redisson 功能介绍
...
**不可重试**：是指目前的分布式获取锁只能尝试一次，我们认为合理的情况是：当线程在获得锁失败后，他应该能再次尝试获得锁。
...
![](https://124.71.187.148/images/redis/1653546070602.png)

那么什么是 Redisson 呢

Redisson 是一个在 Redis 的基础上实现的Java驻内存数据网格（In-Memory Data Grid）。它不仅提供了一系列的分布式的 Java 常用对象，还提供了许多分布式服务，其中就包含了各种分布式锁的实现。

Redisson 提供了分布式锁的多种多样的功能

![](https://124.71.187.148/images/redis/1653546736063.png)

### 5.2、分布式锁-Redisson 快速入门
...
### 5.3、分布式锁-Redisson 可重入锁原理

在 Lock 锁中，他是借助于底层的一个 volatile 的一个state变量来记录重入的状态的，比如当前没有人持有这把锁，那么 state=0，假如有人持有这把锁，那么 state=1，如果持有这把锁的人再次持有这把锁，那么 state 就会 +1 ，如果是对于 synchronized 而言，他在 c 语言代码中会有一个 count，原理和 state 类似，也是重入一次就加一，释放一次就 -1 ，直到减少成 0 时，表示当前这把锁没有被人持有。

在 Redisson 中，我们的也支持支持可重入锁。

在分布式锁中，他采用 hash 结构用来存储锁，其中大 key 表示表示这把锁是否存在，用小 key 表示当前这把锁被哪个线程持有。接下来我们一起分析一下当前的这个 lua 表达式

![](https://124.71.187.148/images/redis/202310091402000001.png)
...
![](https://124.71.187.148/images/redis/202310091402000002.png)

### 5.4、分布式锁-Redisson 锁重试和 WatchDog 机制

![](https://124.71.187.148/images/redis/202310091520000001.png)
...
![](https://124.71.187.148/images/redis/1653553998403.png)

为了解决这个问题，redission提出来了MutiLock锁，使用这把锁咱们就不使用主从了，每个节点的地位都是一样的， 这把锁加锁的逻辑需要写入到每一个主丛节点上，只有所有的服务器都写入成功，此时才是加锁成功，假设现在某个节点挂了，那么他去获得锁的时候，只要有一个节点拿不到，都不能算是加锁成功，就保证了加锁的可靠性。

![](https://124.71.187.148/images/redis/1653554055048.png)

那么MutiLock 加锁原理是什么呢？笔者画了一幅图来说明

当我们去设置了多个锁时，redission会将多个锁添加到一个集合中，然后用while循环去不停去尝试拿锁，但是会有一个总共的加锁时间，这个时间是用需要加锁的个数 * 1500ms ，假设有3个锁，那么时间就是4500ms，假设在这4500ms内，所有的锁都加锁成功， 那么此时才算是加锁成功，如果在4500ms有线程加锁失败，则会再次去进行重试.

![](https://124.71.187.148/images/redis/1653553093967.png)
...
![](https://124.71.187.148/images/redis/1656080546603.png)
...
### 9.2、附近商户-导入店铺数据到 GEO

具体场景说明：

![](https://124.71.187.148/images/redis/1653822036941.png)
...
![](https://124.71.187.148/images/redis/1653822021827.png)
...
public Result queryShopByType(Integer typeId, Integer current, Double x, Double y) {
    ...
    GeoResults<RedisGeoCommands.GeoLocation<String>> results = redisTemplate.opsForGeo() // GEOSEARCH key BYLONLAT x y BYRADIUS 10 WITHDISTANCE
            .search(
                    ...
                    new Distance(SystemConstants.DEFAULT_SHOP_DISTANCE),
...
![](https://124.71.187.148/images/redis/1653824498278.png)

BitMap 的操作命令有：

* SETBIT：向指定位置（offset）存入一个0或1
* GETBIT ：获取指定位置（offset）的bit值
* BITCOUNT ：统计 BitMap 中值为 1 的bit位的数量
...
思路：我们可以把年和月作为 bitMap 的 key，然后保存到一个 bitMap 中，每次签到就到对应的位上把数字从 0 变成 1，只要对应是1，就表明说明这一天已经签到了，反之则没有签到。

我们通过接口文档发现，此接口并没有传递任何的参数，没有参数怎么确实是哪一天签到呢？这个很容易，可以通过后台代码直接获取即可，然后到对应的地址上去修改 bitMap。

![](https://124.71.187.148/images/redis/1653833970361.png)
...
![](https://124.71.187.148/images/redis/1653834455899.png)
...
![](https://124.71.187.148/images/redis/1653835784444.png)
...
### 10.4、额外加餐-关于使用 bitmap 来解决缓存穿透的方案
...
![](https://124.71.187.148/images/redis/1653836416586.png)
...
id % bitmap.size  = 算出当前这个 id 对应应该落在 bitmap的哪个索引上，然后将这个值从 0 变成 1，然后当用户来查询数据时，此时已经没有了 list，让用户用他查询的 id 去用相同的哈希算法， 算出来当前这个 id 应当落在 bitmap 的哪一位，然后判断这一位是 0，还是 1，如果是 0 则表明这一位上的数据一定不存在，采用这种方式来处理，需要重点考虑一个事情，就是误差率，所谓的误差率就是指当发生哈希冲突的时候，产生的误差。

![](https://124.71.187.148/images/redis/1653836578970.png)

## 11、UV 统计

### 11.1 、UV 统计-HyperLogLog
...
![](https://124.71.187.148/images/redis/1653837988985.png)
