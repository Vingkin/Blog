<template><div><h2 id="stream-vs-channel" tabindex="-1"><a class="header-anchor" href="#stream-vs-channel" aria-hidden="true">#</a> stream vs channel</h2>
<ul>
...
<h2 id="io-模型" tabindex="-1"><a class="header-anchor" href="#io-模型" aria-hidden="true">#</a> IO 模型</h2>
...
<figure><img src="https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/os/0033.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul>
<li>
<p>阻塞 IO</p>
<figure><img src="https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/os/0039.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
</li>
<li>
<p>非阻塞 IO</p>
<figure><img src="https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/os/0035.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
</li>
<li>
<p>多路复用</p>
<figure><img src="https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/os/0038.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
</li>
<li>
<p>信号驱动</p>
</li>
<li>
<p>异步 IO</p>
<figure><img src="https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/os/0037.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
</li>
<li>
<p>阻塞 IO vs 多路复用</p>
<figure><img src="https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/os/0034.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<figure><img src="https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/os/0036.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
</li>
</ul>
<h3 id="参考🔖" tabindex="-1"><a class="header-anchor" href="#参考🔖" aria-hidden="true">#</a> 参考🔖</h3>
<p>UNIX 网络编程 - 卷 I</p>
<h2 id="零拷贝" tabindex="-1"><a class="header-anchor" href="#零拷贝" aria-hidden="true">#</a> 零拷贝</h2>
<h3 id="传统-io-问题" tabindex="-1"><a class="header-anchor" href="#传统-io-问题" aria-hidden="true">#</a> 传统 IO 问题</h3>
...
<figure><img src="https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/os/0024.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ol>
...
<h3 id="nio-优化" tabindex="-1"><a class="header-anchor" href="#nio-优化" aria-hidden="true">#</a> NIO 优化</h3>
...
<figure><img src="https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/os/0025.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/os/0026.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ol>
...
<p>进一步优化（linux 2.4）</p>
<figure><img src="https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/os/0027.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ol>
<li>java 调用 transferTo 方法后，要从 java 程序的<strong>用户态</strong>切换至<strong>内核态</strong>，使用 DMA将数据读入<strong>内核缓冲区</strong>，不会使用 cpu</li>
...
<h3 id="文件-aio" tabindex="-1"><a class="header-anchor" href="#文件-aio" aria-hidden="true">#</a> 文件 AIO</h3>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>13:44:56 [DEBUG] [main] c.i.aio.AioDemo1 - begin...
...
|00000000| 61 0d                                           |a.              |
+--------+-------------------------------------------------+----------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看到</p>
<ul>
...
<p>默认文件 AIO 使用的线程都是守护线程，所以最后要执行 <code v-pre>System.in.read()</code> 以避免守护线程意外结束</p>
<h3 id="网络-aio" tabindex="-1"><a class="header-anchor" href="#网络-aio" aria-hidden="true">#</a> 网络 AIO</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">AioServer</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
