<template><div><h2 id="_1-hive表设计优化" tabindex="-1"><a class="header-anchor" href="#_1-hive表设计优化" aria-hidden="true">#</a> 1. Hive表设计优化</h2>
<h3 id="_1-1-分区表结构设计" tabindex="-1"><a class="header-anchor" href="#_1-1-分区表结构设计" aria-hidden="true">#</a> 1.1 分区表结构设计</h3>
<blockquote>
<p>Hive在执行查询计划时，会<strong>使用表的最后一级目录作为底层处理数据的输入</strong>。如果不使用分区表，那么表目录下的所有文件将都会被加载，会导致大量磁盘和网络的IO损耗。</p>
</blockquote>
<h4 id="_1-1-1-普通表结构问题" tabindex="-1"><a class="header-anchor" href="#_1-1-1-普通表结构问题" aria-hidden="true">#</a> 1.1.1 普通表结构问题</h4>
<ul>
...
<h4 id="_1-1-2-分区设计思想" tabindex="-1"><a class="header-anchor" href="#_1-1-2-分区设计思想" aria-hidden="true">#</a> 1.1.2 分区设计思想</h4>
...
<h3 id="_1-2-分桶表结构设计" tabindex="-1"><a class="header-anchor" href="#_1-2-分桶表结构设计" aria-hidden="true">#</a> 1.2 分桶表结构设计</h3>
<h4 id="_1-2-1-分桶表设计思想" tabindex="-1"><a class="header-anchor" href="#_1-2-1-分桶表设计思想" aria-hidden="true">#</a> 1.2.1 分桶表设计思想</h4>
<blockquote>
...
<h4 id="_1-2-2-优化join" tabindex="-1"><a class="header-anchor" href="#_1-2-2-优化join" aria-hidden="true">#</a> 1.2.2 优化Join</h4>
...
<h3 id="_1-3-索引设计" tabindex="-1"><a class="header-anchor" href="#_1-3-索引设计" aria-hidden="true">#</a> 1.3 索引设计</h3>
<blockquote>
<p>实际工作场景中，一般不推荐使用Hive Index，推荐使用ORC文件格式中的索引、物化视图来代替Hive Index提高查询性能。</p>
</blockquote>
<h4 id="_1-3-1-hive中的索引" tabindex="-1"><a class="header-anchor" href="#_1-3-1-hive中的索引" aria-hidden="true">#</a> 1.3.1 Hive中的索引</h4>
<ul>
...
<h2 id="_1-3-2-索引的原理" tabindex="-1"><a class="header-anchor" href="#_1-3-2-索引的原理" aria-hidden="true">#</a> 1.3.2 索引的原理</h2>
<p>当为某张表的某个字段创建索引时，Hive中会自动创建一张索引表，该表记录了该字段的每个值与数据实际物理位置之间的关系，例如数据所在的HDFS文件地址，以及所在文件中偏移量offset等信息。</p>
<h4 id="_1-3-3-索引的目的" tabindex="-1"><a class="header-anchor" href="#_1-3-3-索引的目的" aria-hidden="true">#</a> 1.3.3 索引的目的</h4>
<p>提高Hive表指定列的查询速度。没有索引时，类似WHERE tab1.col1 = 10的查询，Hive会加载整张表或分区，然后处理所有的行，但是如果在字段col1上面存在索引时，那么只会加载和处理文件的一部分。</p>
<h4 id="_1-3-4-索引的使用" tabindex="-1"><a class="header-anchor" href="#_1-3-4-索引的使用" aria-hidden="true">#</a> 1.3.4 索引的使用</h4>
<p>创建索引：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_1-3-5-索引的问题" tabindex="-1"><a class="header-anchor" href="#_1-3-5-索引的问题" aria-hidden="true">#</a> 1.3.5 索引的问题</h4>
<ul>
...
<h2 id="_2-hive表数据优化" tabindex="-1"><a class="header-anchor" href="#_2-hive表数据优化" aria-hidden="true">#</a> 2. Hive表数据优化</h2>
<h3 id="_2-1-文件格式" tabindex="-1"><a class="header-anchor" href="#_2-1-文件格式" aria-hidden="true">#</a> 2.1 文件格式</h3>
<blockquote>
...
<h4 id="_2-1-1-textfile" tabindex="-1"><a class="header-anchor" href="#_2-1-1-textfile" aria-hidden="true">#</a> 2.1.1 TextFile</h4>
<ul>
...
<h4 id="_2-1-2-sequencefile" tabindex="-1"><a class="header-anchor" href="#_2-1-2-sequencefile" aria-hidden="true">#</a> 2.1.2 SequenceFile</h4>
<ul>
...
<h4 id="_2-1-3-parquet" tabindex="-1"><a class="header-anchor" href="#_2-1-3-parquet" aria-hidden="true">#</a> 2.1.3 Parquet</h4>
<ul>
...
<h4 id="_2-1-4-orc" tabindex="-1"><a class="header-anchor" href="#_2-1-4-orc" aria-hidden="true">#</a> 2.1.4 ORC</h4>
<ul>
...
<figure><img src="https://vingkin-1304361015.cos.ap-shanghai.myqcloud.com/img/202309251923170.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="_2-2-数据压缩" tabindex="-1"><a class="header-anchor" href="#_2-2-数据压缩" aria-hidden="true">#</a> 2.2 数据压缩</h3>
<h4 id="_2-2-1-概述" tabindex="-1"><a class="header-anchor" href="#_2-2-1-概述" aria-hidden="true">#</a> 2.2.1 概述</h4>
<ul>
...
<h4 id="_2-2-2-使用" tabindex="-1"><a class="header-anchor" href="#_2-2-2-使用" aria-hidden="true">#</a> 2.2.2 使用</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-3-存储优化" tabindex="-1"><a class="header-anchor" href="#_2-3-存储优化" aria-hidden="true">#</a> 2.3 存储优化</h3>
<h4 id="_2-3-1-避免小文件生成" tabindex="-1"><a class="header-anchor" href="#_2-3-1-避免小文件生成" aria-hidden="true">#</a> 2.3.1 避免小文件生成</h4>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-3-2-如何读取小文件" tabindex="-1"><a class="header-anchor" href="#_2-3-2-如何读取小文件" aria-hidden="true">#</a> 2.3.2 如何读取小文件</h4>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-3-3-orc文件索引" tabindex="-1"><a class="header-anchor" href="#_2-3-3-orc文件索引" aria-hidden="true">#</a> 2.3.3 ORC文件索引</h4>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-job作业执行优化" tabindex="-1"><a class="header-anchor" href="#_3-job作业执行优化" aria-hidden="true">#</a> 3. Job作业执行优化</h2>
<h3 id="_3-1-explain查询计划" tabindex="-1"><a class="header-anchor" href="#_3-1-explain查询计划" aria-hidden="true">#</a> 3.1 explain查询计划</h3>
<ul>
...
<h4 id="_3-1-1-语法" tabindex="-1"><a class="header-anchor" href="#_3-1-1-语法" aria-hidden="true">#</a> 3.1.1 语法</h4>
...
<h4 id="_3-1-2-输出组成" tabindex="-1"><a class="header-anchor" href="#_3-1-2-输出组成" aria-hidden="true">#</a> 3.1.2 输出组成</h4>
<ul>
...
<h3 id="_3-2-mapreduce属性优化" tabindex="-1"><a class="header-anchor" href="#_3-2-mapreduce属性优化" aria-hidden="true">#</a> 3.2 MapReduce属性优化</h3>
<h4 id="_3-2-1-本地模式" tabindex="-1"><a class="header-anchor" href="#_3-2-1-本地模式" aria-hidden="true">#</a> 3.2.1 本地模式</h4>
<ul>
...
<h4 id="_3-2-2-jvm重用" tabindex="-1"><a class="header-anchor" href="#_3-2-2-jvm重用" aria-hidden="true">#</a> 3.2.2 JVM重用</h4>
<blockquote>
<p>Hadoop3不再支持</p>
</blockquote>
<ol>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-2-3-并行执行" tabindex="-1"><a class="header-anchor" href="#_3-2-3-并行执行" aria-hidden="true">#</a> 3.2.3 并行执行</h4>
<blockquote>
<p>没有依赖的stage并行执行</p>
</blockquote>
<ol>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-3-join优化" tabindex="-1"><a class="header-anchor" href="#_3-3-join优化" aria-hidden="true">#</a> 3.3 Join优化</h3>
<ul>
...
<h4 id="_3-3-1-map-join" tabindex="-1"><a class="header-anchor" href="#_3-3-1-map-join" aria-hidden="true">#</a> 3.3.1 Map Join</h4>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-3-2-reduce-join" tabindex="-1"><a class="header-anchor" href="#_3-3-2-reduce-join" aria-hidden="true">#</a> 3.3.2 Reduce Join</h4>
<ul>
...
<h4 id="_3-3-3-bucket-join" tabindex="-1"><a class="header-anchor" href="#_3-3-3-bucket-join" aria-hidden="true">#</a> 3.3.3 Bucket Join</h4>
<ul>
<li>
...
<h3 id="_3-4-优化器" tabindex="-1"><a class="header-anchor" href="#_3-4-优化器" aria-hidden="true">#</a> 3.4 优化器</h3>
<h4 id="_3-4-1-背景" tabindex="-1"><a class="header-anchor" href="#_3-4-1-背景" aria-hidden="true">#</a> 3.4.1 背景</h4>
<ul>
...
<h4 id="_3-4-2-使用" tabindex="-1"><a class="header-anchor" href="#_3-4-2-使用" aria-hidden="true">#</a> 3.4.2 使用</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_3-4-3-优化器介绍" tabindex="-1"><a class="header-anchor" href="#_3-4-3-优化器介绍" aria-hidden="true">#</a> 3.4.3 优化器介绍</h4>
...
<h3 id="_3-5-谓词下推-ppd" tabindex="-1"><a class="header-anchor" href="#_3-5-谓词下推-ppd" aria-hidden="true">#</a> 3.5 谓词下推（PPD）</h3>
<blockquote>
<ul>
...
<h4 id="_3-5-1-示例" tabindex="-1"><a class="header-anchor" href="#_3-5-1-示例" aria-hidden="true">#</a> 3.5.1 示例</h4>
...
<h4 id="_3-5-2-规则" tabindex="-1"><a class="header-anchor" href="#_3-5-2-规则" aria-hidden="true">#</a> 3.5.2 规则</h4>
<ol>
...
<h3 id="_3-6-数据倾斜" tabindex="-1"><a class="header-anchor" href="#_3-6-数据倾斜" aria-hidden="true">#</a> 3.6 数据倾斜</h3>
<blockquote>
...
<h4 id="_3-6-1-group-by-count-distinct-时的倾斜" tabindex="-1"><a class="header-anchor" href="#_3-6-1-group-by-count-distinct-时的倾斜" aria-hidden="true">#</a> 3.6.1 group by, count(distinct)时的倾斜</h4>
<blockquote>
...
<h4 id="方案三-数据倾斜时自动负载均衡" tabindex="-1"><a class="header-anchor" href="#方案三-数据倾斜时自动负载均衡" aria-hidden="true">#</a> 方案三：数据倾斜时自动负载均衡</h4>
...
<h4 id="_3-6-2-join时的倾斜" tabindex="-1"><a class="header-anchor" href="#_3-6-2-join时的倾斜" aria-hidden="true">#</a> 3.6.2 join时的倾斜</h4>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-hive3新特性" tabindex="-1"><a class="header-anchor" href="#_4-hive3新特性" aria-hidden="true">#</a> 4. Hive3新特性</h2>
<h3 id="_4-1-hive-on-tez" tabindex="-1"><a class="header-anchor" href="#_4-1-hive-on-tez" aria-hidden="true">#</a> 4.1 Hive on Tez</h3>
<blockquote>
<p>一般都使用Spark了，所以了解就行</p>
</blockquote>
<h3 id="_4-2-hive-llap更新" tabindex="-1"><a class="header-anchor" href="#_4-2-hive-llap更新" aria-hidden="true">#</a> 4.2 Hive LLAP更新</h3>
<blockquote>
<p>只能与Tez配套使用，了解</p>
</blockquote>
<h3 id="_4-3-metastore独立模式" tabindex="-1"><a class="header-anchor" href="#_4-3-metastore独立模式" aria-hidden="true">#</a> 4.3 Metastore独立模式</h3>
<blockquote>
