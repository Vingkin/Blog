<template><div><h2 id="_1-hive-sql-ddl建表基础语法" tabindex="-1"><a class="header-anchor" href="#_1-hive-sql-ddl建表基础语法" aria-hidden="true">#</a> 1 Hive SQL DDL建表基础语法</h2>
<h3 id="_1-1-hive建表完整语法树" tabindex="-1"><a class="header-anchor" href="#_1-1-hive建表完整语法树" aria-hidden="true">#</a> 1.1 Hive建表完整语法树</h3>
<ul>
...
<h3 id="_1-2-hive数据类型详解" tabindex="-1"><a class="header-anchor" href="#_1-2-hive数据类型详解" aria-hidden="true">#</a> 1.2 Hive数据类型详解</h3>
<blockquote>
<p>指的是表中列的字段类型</p>
</blockquote>
<ul>
...
<h3 id="_1-3-hive读写文件机制" tabindex="-1"><a class="header-anchor" href="#_1-3-hive读写文件机制" aria-hidden="true">#</a> 1.3 Hive读写文件机制</h3>
<blockquote>
...
<h4 id="_1-3-1-hive读写文件流程" tabindex="-1"><a class="header-anchor" href="#_1-3-1-hive读写文件流程" aria-hidden="true">#</a> 1.3.1 Hive读写文件流程</h4>
<ul>
...
<h4 id="_1-3-2-serde相关语法" tabindex="-1"><a class="header-anchor" href="#_1-3-2-serde相关语法" aria-hidden="true">#</a> 1.3.2 SerDe相关语法</h4>
<blockquote>
...
<h4 id="_1-3-3-lazysimpleserde分隔符指定" tabindex="-1"><a class="header-anchor" href="#_1-3-3-lazysimpleserde分隔符指定" aria-hidden="true">#</a> 1.3.3 LazySimpleSerDe分隔符指定</h4>
<blockquote>
...
<h3 id="_1-4-hive数据存储路径" tabindex="-1"><a class="header-anchor" href="#_1-4-hive数据存储路径" aria-hidden="true">#</a> 1.4 Hive数据存储路径</h3>
<h4 id="_1-4-1-默认存储路径" tabindex="-1"><a class="header-anchor" href="#_1-4-1-默认存储路径" aria-hidden="true">#</a> 1.4.1 默认存储路径</h4>
...
<h4 id="_1-4-2-指定存储路径" tabindex="-1"><a class="header-anchor" href="#_1-4-2-指定存储路径" aria-hidden="true">#</a> 1.4.2 指定存储路径</h4>
<p>在Hive建表的时候，可以通过<strong>location语法来更改数据在HDFS上的存储路径</strong></p>
<p>语法：<code v-pre>LOCATION '&lt;hdfs_location&gt;'</code></p>
<h3 id="_1-5-基础建表语法联系" tabindex="-1"><a class="header-anchor" href="#_1-5-基础建表语法联系" aria-hidden="true">#</a> 1.5 基础建表语法联系</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-hive-sql-ddl-建表高阶语法" tabindex="-1"><a class="header-anchor" href="#_2-hive-sql-ddl-建表高阶语法" aria-hidden="true">#</a> 2 Hive SQL DDL 建表高阶语法</h2>
<h3 id="_2-1-hive-内部表、外部表" tabindex="-1"><a class="header-anchor" href="#_2-1-hive-内部表、外部表" aria-hidden="true">#</a> 2.1 Hive 内部表、外部表</h3>
<blockquote>
...
<h3 id="_2-2-hive-partitioned-tables-分区表" tabindex="-1"><a class="header-anchor" href="#_2-2-hive-partitioned-tables-分区表" aria-hidden="true">#</a> 2.2 Hive Partitioned Tables 分区表</h3>
<blockquote>
...
<h4 id="_2-2-1-创建分区表" tabindex="-1"><a class="header-anchor" href="#_2-2-1-创建分区表" aria-hidden="true">#</a> 2.2.1 创建分区表</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-2-2-分区表数据加载" tabindex="-1"><a class="header-anchor" href="#_2-2-2-分区表数据加载" aria-hidden="true">#</a> 2.2.2 分区表数据加载</h4>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-2-3-多重分区" tabindex="-1"><a class="header-anchor" href="#_2-2-3-多重分区" aria-hidden="true">#</a> 2.2.3 多重分区</h4>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-3-hive-bucketed-tables-分桶表" tabindex="-1"><a class="header-anchor" href="#_2-3-hive-bucketed-tables-分桶表" aria-hidden="true">#</a> 2.3 Hive Bucketed Tables 分桶表</h3>
<blockquote>
...
<h4 id="_2-3-1-基本语法" tabindex="-1"><a class="header-anchor" href="#_2-3-1-基本语法" aria-hidden="true">#</a> 2.3.1 基本语法</h4>
...
<h4 id="_2-3-2-创建分桶表" tabindex="-1"><a class="header-anchor" href="#_2-3-2-创建分桶表" aria-hidden="true">#</a> 2.3.2 创建分桶表</h4>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-3-3-分桶表数据加载" tabindex="-1"><a class="header-anchor" href="#_2-3-3-分桶表数据加载" aria-hidden="true">#</a> 2.3.3 分桶表数据加载</h4>
<blockquote>
...
<h3 id="_2-4-hive-transactional-tables-事务表" tabindex="-1"><a class="header-anchor" href="#_2-4-hive-transactional-tables-事务表" aria-hidden="true">#</a> 2.4 Hive Transactional Tables 事务表</h3>
...
<h4 id="_2-4-1-创建事务表" tabindex="-1"><a class="header-anchor" href="#_2-4-1-创建事务表" aria-hidden="true">#</a> 2.4.1 创建事务表</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_2-5-hive-view-视图" tabindex="-1"><a class="header-anchor" href="#_2-5-hive-view-视图" aria-hidden="true">#</a> 2.5 Hive View 视图</h3>
<h4 id="_2-5-1-视图的相关概念" tabindex="-1"><a class="header-anchor" href="#_2-5-1-视图的相关概念" aria-hidden="true">#</a> 2.5.1 视图的相关概念</h4>
<ul>
...
<h4 id="_2-5-2-视图的相关语法" tabindex="-1"><a class="header-anchor" href="#_2-5-2-视图的相关语法" aria-hidden="true">#</a> 2.5.2 视图的相关语法</h4>
<ol>
...
<h4 id="_2-5-3-使用视图的好处" tabindex="-1"><a class="header-anchor" href="#_2-5-3-使用视图的好处" aria-hidden="true">#</a> 2.5.3 使用视图的好处</h4>
<ol>
<li>
...
<h3 id="_2-6-materialized-views物化视图" tabindex="-1"><a class="header-anchor" href="#_2-6-materialized-views物化视图" aria-hidden="true">#</a> 2.6 Materialized Views物化视图</h3>
<h4 id="_2-6-1-物化视图相关概念" tabindex="-1"><a class="header-anchor" href="#_2-6-1-物化视图相关概念" aria-hidden="true">#</a> 2.6.1 物化视图相关概念</h4>
<ul>
...
<h4 id="_2-6-2-物化视图和视图的区别" tabindex="-1"><a class="header-anchor" href="#_2-6-2-物化视图和视图的区别" aria-hidden="true">#</a> 2.6.2 物化视图和视图的区别</h4>
<ul>
...
<h4 id="_2-6-3-物化视图相关语法" tabindex="-1"><a class="header-anchor" href="#_2-6-3-物化视图相关语法" aria-hidden="true">#</a> 2.6.3 物化视图相关语法</h4>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_3-hive-sql-ddl-其他语法" tabindex="-1"><a class="header-anchor" href="#_3-hive-sql-ddl-其他语法" aria-hidden="true">#</a> 3 Hive SQL DDL 其他语法</h2>
<h3 id="_3-1-database-schema-数据库-ddl-操作" tabindex="-1"><a class="header-anchor" href="#_3-1-database-schema-数据库-ddl-操作" aria-hidden="true">#</a> 3.1 Database|Schema（数据库）DDL 操作</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2-table-表-ddl操作" tabindex="-1"><a class="header-anchor" href="#_3-2-table-表-ddl操作" aria-hidden="true">#</a> 3.2 Table（表）DDL操作</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-3-partition-分区-ddl操作" tabindex="-1"><a class="header-anchor" href="#_3-3-partition-分区-ddl操作" aria-hidden="true">#</a> 3.3 Partition（分区）DDL操作</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-3-1-msck-修复分区" tabindex="-1"><a class="header-anchor" href="#_3-3-1-msck-修复分区" aria-hidden="true">#</a> 3.3.1 MSCK 修复分区</h4>
<blockquote>
