<template><div><h1 id="_1-hive-sql-dml-load加载数据" tabindex="-1"><a class="header-anchor" href="#_1-hive-sql-dml-load加载数据" aria-hidden="true">#</a> 1. Hive SQL-DML-Load加载数据</h1>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-1-基本操作" tabindex="-1"><a class="header-anchor" href="#_1-1-基本操作" aria-hidden="true">#</a> 1.1 基本操作</h2>
<blockquote>
...
<br/><br>
!!!</p>
<h2 id="_1-2-hive3-0-新特性" tabindex="-1"><a class="header-anchor" href="#_1-2-hive3-0-新特性" aria-hidden="true">#</a> 1.2 Hive3.0 新特性</h2>
<blockquote>
...
<h1 id="_2-hive-sql-dml-insert插入数据" tabindex="-1"><a class="header-anchor" href="#_2-hive-sql-dml-insert插入数据" aria-hidden="true">#</a> 2. Hive SQL-DML-insert插入数据</h1>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-1-基本操作" tabindex="-1"><a class="header-anchor" href="#_2-1-基本操作" aria-hidden="true">#</a> 2.1 基本操作</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-2-from-多重插入" tabindex="-1"><a class="header-anchor" href="#_2-2-from-多重插入" aria-hidden="true">#</a> 2.2 FROM 多重插入</h2>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-3-dynamic-partition-inserts-动态分区插入" tabindex="-1"><a class="header-anchor" href="#_2-3-dynamic-partition-inserts-动态分区插入" aria-hidden="true">#</a> 2.3 Dynamic Partition Inserts 动态分区插入</h2>
<p>还有一个案例如下：</p>
<p>!!!<br>
<a style="color: red" href="https://vingkin.nytdoj.com/index.php/archives/370/#menu_index_16" 
target="_blank">Load加载数据基本操作</a><br>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-4-insert-directory导出数据" tabindex="-1"><a class="header-anchor" href="#_2-4-insert-directory导出数据" aria-hidden="true">#</a> 2.4 Insert Directory导出数据</h2>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_3-hive-transaction-事务表" tabindex="-1"><a class="header-anchor" href="#_3-hive-transaction-事务表" aria-hidden="true">#</a> 3. Hive Transaction 事务表</h1>
...
<br/><br>
!!!</p>
<h2 id="_3-1-实现原理" tabindex="-1"><a class="header-anchor" href="#_3-1-实现原理" aria-hidden="true">#</a> 3.1 实现原理</h2>
<blockquote>
...
<h3 id="_3-1-1-delta文件详解" tabindex="-1"><a class="header-anchor" href="#_3-1-1-delta文件详解" aria-hidden="true">#</a> 3.1.1 delta文件详解</h3>
<ul>
...
<h3 id="_3-1-2-合并器" tabindex="-1"><a class="header-anchor" href="#_3-1-2-合并器" aria-hidden="true">#</a> 3.1.2 合并器</h3>
<blockquote>
...
<h2 id="_3-2-hive-事务表使用设置与局限性" tabindex="-1"><a class="header-anchor" href="#_3-2-hive-事务表使用设置与局限性" aria-hidden="true">#</a> 3.2 Hive 事务表使用设置与局限性</h2>
<h3 id="_3-2-1-局限性" tabindex="-1"><a class="header-anchor" href="#_3-2-1-局限性" aria-hidden="true">#</a> 3.2.1 局限性</h3>
<blockquote>
<p>好像不用分桶表也可以？</p>
</blockquote>
<ol>
...
<h3 id="_3-2-2-参数设置" tabindex="-1"><a class="header-anchor" href="#_3-2-2-参数设置" aria-hidden="true">#</a> 3.2.2 参数设置</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-3-使用事务表" tabindex="-1"><a class="header-anchor" href="#_3-3-使用事务表" aria-hidden="true">#</a> 3.3 使用事务表</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_4-hive-sql-dml-update、delete" tabindex="-1"><a class="header-anchor" href="#_4-hive-sql-dml-update、delete" aria-hidden="true">#</a> 4. Hive SQL-DML-Update、Delete</h1>
<blockquote>
<p>其实这边就是事务表的相关操作没什么好说的</p>
</blockquote>
<h1 id="_5-hive-sql-dql-select-查询数据" tabindex="-1"><a class="header-anchor" href="#_5-hive-sql-dql-select-查询数据" aria-hidden="true">#</a> 5. Hive SQL-DQL-Select 查询数据</h1>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-1-hive-sql-select查询基础语法" tabindex="-1"><a class="header-anchor" href="#_5-1-hive-sql-select查询基础语法" aria-hidden="true">#</a> 5.1 Hive SQL select查询基础语法</h2>
<h3 id="_5-1-1-select-expr" tabindex="-1"><a class="header-anchor" href="#_5-1-1-select-expr" aria-hidden="true">#</a> 5.1.1 select expr</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-1-2-all-、distinct" tabindex="-1"><a class="header-anchor" href="#_5-1-2-all-、distinct" aria-hidden="true">#</a> 5.1.2 ALL 、DISTINCT</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-1-3-where" tabindex="-1"><a class="header-anchor" href="#_5-1-3-where" aria-hidden="true">#</a> 5.1.3 WHERE</h3>
<blockquote>
...
<h3 id="_5-1-4-分区查询" tabindex="-1"><a class="header-anchor" href="#_5-1-4-分区查询" aria-hidden="true">#</a> 5.1.4 分区查询</h3>
<blockquote>
<p>针对的是分区表</p>
</blockquote>
<p>对分区表进行查询时，会检查WHERE子句或JOIN中的ON子句中是否有分区字段，如果有，就会<strong>仅访问符合条件的分区，裁剪掉没有必要访问的分区</strong>。</p>
<h3 id="_5-1-5-group-by" tabindex="-1"><a class="header-anchor" href="#_5-1-5-group-by" aria-hidden="true">#</a> 5.1.5 GROUP BY</h3>
<blockquote>
...
<h3 id="_5-1-5-having" tabindex="-1"><a class="header-anchor" href="#_5-1-5-having" aria-hidden="true">#</a> 5.1.5 HAVING</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-1-6-having和where的区别" tabindex="-1"><a class="header-anchor" href="#_5-1-6-having和where的区别" aria-hidden="true">#</a> 5.1.6 HAVING和WHERE的区别</h3>
<ul>
...
<h3 id="_5-1-7-limit" tabindex="-1"><a class="header-anchor" href="#_5-1-7-limit" aria-hidden="true">#</a> 5.1.7 LIMIT</h3>
<blockquote>
<p>显示SELECT返回的行数</p>
</blockquote>
<ul>
...
<h3 id="_5-1-8-执行顺序" tabindex="-1"><a class="header-anchor" href="#_5-1-8-执行顺序" aria-hidden="true">#</a> 5.1.8 执行顺序</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-2-hive-sql-select查询高阶语法" tabindex="-1"><a class="header-anchor" href="#_5-2-hive-sql-select查询高阶语法" aria-hidden="true">#</a> 5.2 Hive SQL select查询高阶语法</h2>
<h3 id="_5-2-1-order-by" tabindex="-1"><a class="header-anchor" href="#_5-2-1-order-by" aria-hidden="true">#</a> 5.2.1 ORDER BY</h3>
<blockquote>
<p>和RDMBS中的ORDER BY差不多，<strong>用于全局排序</strong>。</p>
<p>默认<strong>ASC（升序）</strong>，可以手动指定为<strong>DESC（降序）</strong></p>
</blockquote>
<h3 id="_5-2-2-cluster-by" tabindex="-1"><a class="header-anchor" href="#_5-2-2-cluster-by" aria-hidden="true">#</a> 5.2.2 CLUSTER BY</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_5-2-3-cluster、distribute、sort、order-by对比" tabindex="-1"><a class="header-anchor" href="#_5-2-3-cluster、distribute、sort、order-by对比" aria-hidden="true">#</a> 5.2.3 CLUSTER、DISTRIBUTE、SORT、ORDER BY对比</h3>
<ol>
...
<h3 id="_5-2-4-union联合查询" tabindex="-1"><a class="header-anchor" href="#_5-2-4-union联合查询" aria-hidden="true">#</a> 5.2.4 UNION联合查询</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-2-5-form-子句中的子查询" tabindex="-1"><a class="header-anchor" href="#_5-2-5-form-子句中的子查询" aria-hidden="true">#</a> 5.2.5 FORM 子句中的子查询</h3>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-2-6-where-子句中的子查询" tabindex="-1"><a class="header-anchor" href="#_5-2-6-where-子句中的子查询" aria-hidden="true">#</a> 5.2.6 WHERE 子句中的子查询</h3>
<ul>
...
<span class="token keyword">select</span> <span class="token operator">*</span>
<span class="token keyword">from</span> q1<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_6-hive-sql-join连接操作" tabindex="-1"><a class="header-anchor" href="#_6-hive-sql-join连接操作" aria-hidden="true">#</a> 6. Hive SQL Join连接操作</h1>
<h2 id="_6-1-inner-join-内连接" tabindex="-1"><a class="header-anchor" href="#_6-1-inner-join-内连接" aria-hidden="true">#</a> 6.1 inner join 内连接</h2>
<blockquote>
...
<h2 id="_6-2-left-join-左连接" tabindex="-1"><a class="header-anchor" href="#_6-2-left-join-左连接" aria-hidden="true">#</a> 6.2 left join 左连接</h2>
<blockquote>
...
<h2 id="_6-3-right-join-右连接" tabindex="-1"><a class="header-anchor" href="#_6-3-right-join-右连接" aria-hidden="true">#</a> 6.3 right join 右连接</h2>
<blockquote>
...
<h2 id="_6-4-full-outer-join-全外连接" tabindex="-1"><a class="header-anchor" href="#_6-4-full-outer-join-全外连接" aria-hidden="true">#</a> 6.4 full outer join 全外连接</h2>
<blockquote>
...
<h2 id="_6-5-left-semi-join-左半开连接" tabindex="-1"><a class="header-anchor" href="#_6-5-left-semi-join-左半开连接" aria-hidden="true">#</a> 6.5 left semi join 左半开连接</h2>
<blockquote>
...
<h2 id="_6-6-cross-join-交叉连接" tabindex="-1"><a class="header-anchor" href="#_6-6-cross-join-交叉连接" aria-hidden="true">#</a> 6.6 cross join 交叉连接</h2>
<blockquote>
