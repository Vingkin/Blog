<template><div><h2 id="_1-hive中多字节分隔符处理" tabindex="-1"><a class="header-anchor" href="#_1-hive中多字节分隔符处理" aria-hidden="true">#</a> 1. Hive中多字节分隔符处理</h2>
<blockquote>
...
<h3 id="_1-1-问题和需求" tabindex="-1"><a class="header-anchor" href="#_1-1-问题和需求" aria-hidden="true">#</a> 1.1 问题和需求</h3>
<p>比如下面的两种情况：</p>
...
<h3 id="_1-2-解决方案一-替换分隔符" tabindex="-1"><a class="header-anchor" href="#_1-2-解决方案一-替换分隔符" aria-hidden="true">#</a> 1.2 解决方案一：替换分隔符</h3>
<blockquote>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-3-解决方案二-regexserde正则加载" tabindex="-1"><a class="header-anchor" href="#_1-3-解决方案二-regexserde正则加载" aria-hidden="true">#</a> 1.3 解决方案二：RegexSerDe正则加载</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-4-解决方案三-自定义inputformat" tabindex="-1"><a class="header-anchor" href="#_1-4-解决方案三-自定义inputformat" aria-hidden="true">#</a> 1.4 解决方案三：自定义InputFormat</h3>
<blockquote>
<p>过于繁琐，不推荐使用。</p>
</blockquote>
<h2 id="_2-url解析函数" tabindex="-1"><a class="header-anchor" href="#_2-url解析函数" aria-hidden="true">#</a> 2. URL解析函数</h2>
<blockquote>
...
<h3 id="_2-1-parse-url" tabindex="-1"><a class="header-anchor" href="#_2-1-parse-url" aria-hidden="true">#</a> 2.1 parse_url</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-parse-url-tuple" tabindex="-1"><a class="header-anchor" href="#_2-2-parse-url-tuple" aria-hidden="true">#</a> 2.2 parse_url_tuple</h3>
...
<h2 id="_3-行列转换应用与实现" tabindex="-1"><a class="header-anchor" href="#_3-行列转换应用与实现" aria-hidden="true">#</a> 3. 行列转换应用与实现</h2>
<h3 id="_3-1-行转列-多行转多列" tabindex="-1"><a class="header-anchor" href="#_3-1-行转列-多行转多列" aria-hidden="true">#</a> 3.1 行转列：多行转多列</h3>
<blockquote>
<p>使用case when语句</p>
<ul>
...
<h4 id="_3-1-1-需求" tabindex="-1"><a class="header-anchor" href="#_3-1-1-需求" aria-hidden="true">#</a> 3.1.1 需求</h4>
...
<h4 id="_3-1-2-实现" tabindex="-1"><a class="header-anchor" href="#_3-1-2-实现" aria-hidden="true">#</a> 3.1.2 实现</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2-行转列-多行转单列" tabindex="-1"><a class="header-anchor" href="#_3-2-行转列-多行转单列" aria-hidden="true">#</a> 3.2 行转列：多行转单列</h3>
<blockquote>
<p>使用concat,concat_ws,collect_list,collect_set等函数</p>
</blockquote>
<h4 id="_3-2-1-需求" tabindex="-1"><a class="header-anchor" href="#_3-2-1-需求" aria-hidden="true">#</a> 3.2.1 需求</h4>
...
<h4 id="_3-2-2-实现" tabindex="-1"><a class="header-anchor" href="#_3-2-2-实现" aria-hidden="true">#</a> 3.2.2 实现</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-3-列转行-多列转多行" tabindex="-1"><a class="header-anchor" href="#_3-3-列转行-多列转多行" aria-hidden="true">#</a> 3.3 列转行：多列转多行</h3>
<blockquote>
...
<h4 id="_3-3-1-需求" tabindex="-1"><a class="header-anchor" href="#_3-3-1-需求" aria-hidden="true">#</a> 3.3.1 需求</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-4-列转行-单列转多行" tabindex="-1"><a class="header-anchor" href="#_3-4-列转行-单列转多行" aria-hidden="true">#</a> 3.4 列转行：单列转多行</h3>
<blockquote>
<p>explode函数的使用，注意explode的参数只能是Map或者Array</p>
</blockquote>
<h4 id="_3-4-1-需求" tabindex="-1"><a class="header-anchor" href="#_3-4-1-需求" aria-hidden="true">#</a> 3.4.1 需求</h4>
...
<h4 id="_3-4-2-实现" tabindex="-1"><a class="header-anchor" href="#_3-4-2-实现" aria-hidden="true">#</a> 3.4.2 实现</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-json数据处理" tabindex="-1"><a class="header-anchor" href="#_4-json数据处理" aria-hidden="true">#</a> 4. Json数据处理</h2>
<h3 id="_4-1-hive中的json处理方式" tabindex="-1"><a class="header-anchor" href="#_4-1-hive中的json处理方式" aria-hidden="true">#</a> 4.1 Hive中的Json处理方式</h3>
<ol>
<li>使用Json函数处理：<code v-pre>get_json_object</code>,<code v-pre>json_tuple</code></li>
<li>Json SerDe加载数据</li>
</ol>
<h3 id="_4-2-json函数" tabindex="-1"><a class="header-anchor" href="#_4-2-json函数" aria-hidden="true">#</a> 4.2 Json函数</h3>
<h4 id="_4-2-1-get-json-object" tabindex="-1"><a class="header-anchor" href="#_4-2-1-get-json-object" aria-hidden="true">#</a> 4.2.1 get_json_object</h4>
<blockquote>
...
<h4 id="_4-2-2-json-tuple" tabindex="-1"><a class="header-anchor" href="#_4-2-2-json-tuple" aria-hidden="true">#</a> 4.2.2 json_tuple</h4>
<blockquote>
...
<h3 id="_4-3-json-serde" tabindex="-1"><a class="header-anchor" href="#_4-3-json-serde" aria-hidden="true">#</a> 4.3 Json SerDe</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-窗口函数应用实例" tabindex="-1"><a class="header-anchor" href="#_5-窗口函数应用实例" aria-hidden="true">#</a> 5. 窗口函数应用实例</h2>
<h3 id="_5-1-案例1-连续登录用户" tabindex="-1"><a class="header-anchor" href="#_5-1-案例1-连续登录用户" aria-hidden="true">#</a> 5.1 案例1：连续登录用户</h3>
<ul>
<li>
...
<h4 id="_5-1-1-实现" tabindex="-1"><a class="header-anchor" href="#_5-1-1-实现" aria-hidden="true">#</a> 5.1.1 实现</h4>
...
<span class="token keyword">from</span> t1
<span class="token keyword">where</span> nextday <span class="token operator">=</span> nextlogin<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-2-案例2-级联累加求和" tabindex="-1"><a class="header-anchor" href="#_5-2-案例2-级联累加求和" aria-hidden="true">#</a> 5.2 案例2：级联累加求和</h3>
<blockquote>
<p>需求：统计每个用户每个月的消费总金额以及<strong>当前累计消费总金额</strong></p>
</blockquote>
<p>窗口函数sum默认就是从第一列到当前列求和，也就是满足当前累计消费总金额这个需求</p>
<h4 id="_5-2-1-实现" tabindex="-1"><a class="header-anchor" href="#_5-2-1-实现" aria-hidden="true">#</a> 5.2.1 实现</h4>
...
<h3 id="_5-3-案例3-分组topn" tabindex="-1"><a class="header-anchor" href="#_5-3-案例3-分组topn" aria-hidden="true">#</a> 5.3 案例3：分组TopN</h3>
<blockquote>
...
<h4 id="_5-3-1-实现" tabindex="-1"><a class="header-anchor" href="#_5-3-1-实现" aria-hidden="true">#</a> 5.3.1 实现</h4>
...
<h2 id="_6-拉链表的设计与实现" tabindex="-1"><a class="header-anchor" href="#_6-拉链表的设计与实现" aria-hidden="true">#</a> 6. 拉链表的设计与实现</h2>
<blockquote>
...
<p>[/scode]</p>
<h3 id="_6-1-实现过程" tabindex="-1"><a class="header-anchor" href="#_6-1-实现过程" aria-hidden="true">#</a> 6.1 实现过程</h3>
...
<h4 id="_6-1-1-创建拉链表" tabindex="-1"><a class="header-anchor" href="#_6-1-1-创建拉链表" aria-hidden="true">#</a> 6.1.1 创建拉链表</h4>
...
<h4 id="_6-1-2-创建增量表" tabindex="-1"><a class="header-anchor" href="#_6-1-2-创建增量表" aria-hidden="true">#</a> 6.1.2 创建增量表</h4>
...
<h4 id="_6-1-3-临时表操作" tabindex="-1"><a class="header-anchor" href="#_6-1-3-临时表操作" aria-hidden="true">#</a> 6.1.3 临时表操作</h4>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_6-1-4-覆盖到拉链表" tabindex="-1"><a class="header-anchor" href="#_6-1-4-覆盖到拉链表" aria-hidden="true">#</a> 6.1.4 覆盖到拉链表</h4>
