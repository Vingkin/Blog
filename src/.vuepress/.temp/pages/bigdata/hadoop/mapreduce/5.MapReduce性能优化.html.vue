<template><div><h1 id="_1-io性能优化-文件类型" tabindex="-1"><a class="header-anchor" href="#_1-io性能优化-文件类型" aria-hidden="true">#</a> 1. IO性能优化：文件类型</h1>
<h2 id="_1-1-行式存储、列式存储" tabindex="-1"><a class="header-anchor" href="#_1-1-行式存储、列式存储" aria-hidden="true">#</a> 1.1 行式存储、列式存储</h2>
