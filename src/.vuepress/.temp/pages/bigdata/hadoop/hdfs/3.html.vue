<template><div><h2 id="_1-hdfs-trash垃圾桶" tabindex="-1"><a class="header-anchor" href="#_1-hdfs-trash垃圾桶" aria-hidden="true">#</a> 1. HDFS Trash垃圾桶</h2>
<blockquote>
<p>该概念就和Windows的垃圾桶一样，默认不开启</p>
</blockquote>
<h3 id="_1-1-功能描述" tabindex="-1"><a class="header-anchor" href="#_1-1-功能描述" aria-hidden="true">#</a> 1.1 功能描述</h3>
<ul>
...
<h3 id="_1-2-功能开启" tabindex="-1"><a class="header-anchor" href="#_1-2-功能开启" aria-hidden="true">#</a> 1.2 功能开启</h3>
<ol>
<li>
...
<h2 id="_2-hdfs-snapshot快照" tabindex="-1"><a class="header-anchor" href="#_2-hdfs-snapshot快照" aria-hidden="true">#</a> 2. HDFS Snapshot快照</h2>
<blockquote>
<p>快照（Snapshot）是<strong>数据存储的某一时刻的状态记录</strong>。HDFS Snapshot快照是整个文件系统或某个目录在某个时刻的镜像。</p>
</blockquote>
<h3 id="_2-1-快照的作用" tabindex="-1"><a class="header-anchor" href="#_2-1-快照的作用" aria-hidden="true">#</a> 2.1 快照的作用</h3>
<ul>
...
<h3 id="_2-2-快照功能的理论实现" tabindex="-1"><a class="header-anchor" href="#_2-2-快照功能的理论实现" aria-hidden="true">#</a> 2.2 快照功能的理论实现</h3>
<ul>
...
<h3 id="_2-3-快照功能的命令实现" tabindex="-1"><a class="header-anchor" href="#_2-3-快照功能的命令实现" aria-hidden="true">#</a> 2.3 快照功能的命令实现</h3>
<ul>
<li>
...
<h2 id="_3-hdfs权限管理" tabindex="-1"><a class="header-anchor" href="#_3-hdfs权限管理" aria-hidden="true">#</a> 3. HDFS权限管理</h2>
<h3 id="_3-1-aaa" tabindex="-1"><a class="header-anchor" href="#_3-1-aaa" aria-hidden="true">#</a> 3.1 AAA</h3>
<blockquote>
...
<h3 id="_3-2-ugo权限管理" tabindex="-1"><a class="header-anchor" href="#_3-2-ugo权限管理" aria-hidden="true">#</a> 3.2 UGO权限管理</h3>
<blockquote>
...
<h4 id="_3-2-1-读、写、执行权限" tabindex="-1"><a class="header-anchor" href="#_3-2-1-读、写、执行权限" aria-hidden="true">#</a> 3.2.1 读、写、执行权限</h4>
<ul>
<li>
...
<h4 id="_3-2-2-umask权限掩码" tabindex="-1"><a class="header-anchor" href="#_3-2-2-umask权限掩码" aria-hidden="true">#</a> 3.2.2 umask权限掩码</h4>
<blockquote>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>property</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-2-3-ugo相关命令" tabindex="-1"><a class="header-anchor" href="#_3-2-3-ugo相关命令" aria-hidden="true">#</a> 3.2.3 UGO相关命令</h4>
...
<h3 id="_3-3-hdfs用户身份认证" tabindex="-1"><a class="header-anchor" href="#_3-3-hdfs用户身份认证" aria-hidden="true">#</a> 3.3 HDFS用户身份认证</h3>
<blockquote>
...
<h4 id="_3-3-1-simple认证" tabindex="-1"><a class="header-anchor" href="#_3-3-1-simple认证" aria-hidden="true">#</a> 3.3.1 Simple认证</h4>
<blockquote>
...
<h4 id="_3-3-2-kerberos认证" tabindex="-1"><a class="header-anchor" href="#_3-3-2-kerberos认证" aria-hidden="true">#</a> 3.3.2 Kerberos认证</h4>
<blockquote>
...
<h3 id="_3-4-hdfs-group-mapping组映射" tabindex="-1"><a class="header-anchor" href="#_3-4-hdfs-group-mapping组映射" aria-hidden="true">#</a> 3.4 HDFS Group Mapping组映射</h3>
<blockquote>
...
<h3 id="_3-5-acl权限管理" tabindex="-1"><a class="header-anchor" href="#_3-5-acl权限管理" aria-hidden="true">#</a> 3.5 ACL权限管理</h3>
<blockquote>
...
<h4 id="_3-5-1-相关命令" tabindex="-1"><a class="header-anchor" href="#_3-5-1-相关命令" aria-hidden="true">#</a> 3.5.1 相关命令</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-hdfs-proxy-user代理用户" tabindex="-1"><a class="header-anchor" href="#_4-hdfs-proxy-user代理用户" aria-hidden="true">#</a> 4. HDFS Proxy user代理用户</h2>
<blockquote>
...
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>property</span><span class="token punctuation">></span></span>
 ...
 <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>property</span><span class="token punctuation">></span></span>
   ...
   <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>value</span><span class="token punctuation">></span></span>*<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>value</span><span class="token punctuation">></span></span>
 <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>property</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-hdfs透明加密" tabindex="-1"><a class="header-anchor" href="#_5-hdfs透明加密" aria-hidden="true">#</a> 5. HDFS透明加密</h2>
<blockquote>
<p>对HDFS的指定目录进行透明加密，通过Web UI界面访问或者hadoop fs -cat访问仿佛就是未加密的文件，以为上面两种方法访问时实现了自动解密。通过直接产看块信息时是加密的。</p>
</blockquote>
<h3 id="_5-1-相关概念" tabindex="-1"><a class="header-anchor" href="#_5-1-相关概念" aria-hidden="true">#</a> 5.1 相关概念</h3>
<h4 id="加密区域" tabindex="-1"><a class="header-anchor" href="#加密区域" aria-hidden="true">#</a> 加密区域</h4>
<blockquote>
<p>所谓加密区域其实就是一个目录</p>
</blockquote>
<h4 id="密钥" tabindex="-1"><a class="header-anchor" href="#密钥" aria-hidden="true">#</a> 密钥</h4>
<ul>
<li>
...
<h4 id="密钥库" tabindex="-1"><a class="header-anchor" href="#密钥库" aria-hidden="true">#</a> 密钥库</h4>
<p>存储密钥（key）的叫做密钥库（keystore）,将HDFS与外部企业级密钥库（keystore）集成是部署透明加密的第一步。</p>
<p>与HDFS本身是分离的</p>
<h4 id="密钥管理服务-kms" tabindex="-1"><a class="header-anchor" href="#密钥管理服务-kms" aria-hidden="true">#</a> 密钥管理服务（KMS）</h4>
<blockquote>
...
<h4 id="写入加密文件的过程" tabindex="-1"><a class="header-anchor" href="#写入加密文件的过程" aria-hidden="true">#</a> 写入加密文件的过程</h4>
...
<h4 id="读取解密文件的过程" tabindex="-1"><a class="header-anchor" href="#读取解密文件的过程" aria-hidden="true">#</a> 读取解密文件的过程</h4>
<ul>
<li>
...
<h3 id="_5-2-kms配置" tabindex="-1"><a class="header-anchor" href="#_5-2-kms配置" aria-hidden="true">#</a> 5.2 KMS配置</h3>
<ol>
<li>
<p>关闭HDFS集群</p>
</li>
